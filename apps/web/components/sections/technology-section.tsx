...
const sideImages = [
  {
    ...
    alt: "Controlled browser session for agent workflows",
    position: "left",
  },
  {
    src: "/images/rusted-metal.png",
    alt: "Protected credential and policy layer",
    position: "right",
  },
];
...
export function TechnologySection() {
  ...
  const descriptionText = "AegisWeb controls authority, not execution. Agents can read billing pages, download invoices, check renewals, and prepare plan changes, while policy rules decide whether each action is allowed, denied, paused for approval, or recorded as evidence.";
  ...
  return (
    <section ref={sectionRef} className="relative bg-foreground">
          ...
          >
            ...
            >
              ...
              <Image
                ...
                alt="Agent identity and allowed workflow layer"
                fill
                className="object-cover"
                style={{
              ...
              <Image
                ...
                alt="Website allowlist and action policy layer"
                fill
              ...
              <Image
                ...
                alt="Credential vault and browser runtime layer"
                fill
                className="absolute inset-0 object-cover"
                style={{
              ...
              <Image
                ...
                alt="Approval and audit receipt layer"
                fill
                className="absolute inset-0 object-cover"
                style={{
      ...
      <div className="relative overflow-hidden px-6 py-24 md:px-12 md:py-32 lg:px-20 lg:py-40 bg-black">
