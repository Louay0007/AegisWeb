    ...
    <section id="about" className="bg-background">
      ...
      <div className="relative aspect-[16/9] w-full">
        <Image
          ...
          alt="AegisWeb trust layer protecting agentic web actions"
          fill
        ...
        <div className="absolute inset-0 flex items-end justify-center px-6 pb-16 md:px-12 md:pb-24 lg:px-20 lg:pb-32">
          <p className="mx-auto max-w-5xl text-2xl leading-relaxed text-white md:text-3xl lg:text-[2.5rem] lg:leading-snug text-center">
            Companies want agents to handle SaaS invoices, renewals, and vendor portals.
            AegisWeb makes those actions permissioned, approved, credential-safe, and auditable.
          </p>
        </div>
      </div>
    </section>
