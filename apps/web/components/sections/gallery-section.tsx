...
export function GallerySection() {
  ...
  const images = [
    { src: "/images/mono-1.png", alt: "Agent identity layer for web automation" },
    { src: "/images/mono-2.png", alt: "Policy engine deciding an agent action" },
    { src: "/images/mono-3.png", alt: "Credential vault protecting vendor access" },
    { src: "/images/mono-4.png", alt: "Audit trail recording an approved workflow" },
  ];
