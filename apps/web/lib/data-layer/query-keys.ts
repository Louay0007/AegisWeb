...
export const queryKeys = {
  agents: {
    ...
    paginatedList: (page: number, limit: number) => [...queryKeys.agents.all, "list", page, limit] as const,
    detail: (id: string) => [...queryKeys.agents.all, "detail", id] as const,
  },
  vendors: {
    all: ["vendors"] as const,
    list: () => [...queryKeys.vendors.all, "list"] as const,
    paginatedList: (page: number, limit: number) => [...queryKeys.vendors.all, "list", page, limit] as const,
    detail: (id: string) => [...queryKeys.vendors.all, "detail", id] as const,
  },
  credentials: {
    all: ["credentials"] as const,
    list: () => [...queryKeys.credentials.all, "list"] as const,
    paginatedList: (page: number, limit: number) => [...queryKeys.credentials.all, "list", page, limit] as const,
    detail: (id: string) => [...queryKeys.credentials.all, "detail", id] as const,
  },
  policies: {
    all: ["policies"] as const,
    list: () => [...queryKeys.policies.all, "list"] as const,
    paginatedList: (page: number, limit: number) => [...queryKeys.policies.all, "list", page, limit] as const,
    detail: (id: string) => [...queryKeys.policies.all, "detail", id] as const,
  },
  workflows: {
    all: ["workflows"] as const,
    list: () => [...queryKeys.workflows.all, "list"] as const,
    paginatedList: (page: number, limit: number) => [...queryKeys.workflows.all, "list", page, limit] as const,
  ...
  workflowRuns: {
    ...
    paginatedList: (page: number, limit: number) => [...queryKeys.workflowRuns.all, "list", page, limit] as const,
  ...
  approvals: {
    ...
    paginatedList: (page: number, limit: number) => [...queryKeys.approvals.all, "list", page, limit] as const,
    detail: (id: string) => [...queryKeys.approvals.all, "detail", id] as const,
  },
  receipts: {
    all: ["receipts"] as const,
    list: () => [...queryKeys.receipts.all, "list"] as const,
    paginatedList: (page: number, limit: number) => [...queryKeys.receipts.all, "list", page, limit] as const,
  ...
  audit: {
    ...
    paginatedList: (page: number, limit: number) => [...queryKeys.audit.all, "paginated", page, limit] as const,
  },
  organization: {
  ...
  users: {
    ...
    paginatedList: (page: number, limit: number) => [...queryKeys.users.all, "list", page, limit] as const,
  },
} as const;
